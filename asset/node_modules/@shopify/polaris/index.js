...
var UnstyledLink = React__default.memo( // eslint-disable-next-line react/display-name
...
var getUniqueID$2 = other.createUniqueIDFactory('DropZone');
...
function (_React$Component) {
  ...
  _createClass(Filters, [{
    ...
    value: function render() {
      ...
      }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, backdropMarkup, React__default.createElement(KeypressListener, {
        keyCode: exports.Key.Escape,
...
var getUniqueID$3 = other.createUniqueIDFactory('modal-header');
...
var getUniqueID$4 = other.createUniqueIDFactory('TooltipContent');
var Tooltip =
/*#__PURE__*/
function (_React$PureComponent) {
...
})(DateFilterOption || (DateFilterOption = {})); // This does have a display name, but the linting has a bug in it
// https://github.com/yannickcr/eslint-plugin-react/issues/2324
// eslint-disable-next-line react/display-name
