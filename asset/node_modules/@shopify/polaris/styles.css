...
.Polaris-Button{
  ...
  border:0.1rem solid var(--p-divider-on-surface, #c4cdd5);
...
.Polaris-Button--outline{
  ...
  .Polaris-Button--outline.Polaris-Button--globalTheming{
    ...
    .Polaris-Button--outline.Polaris-Button--globalTheming.Polaris-Button--disabled{
      box-shadow:0 0 0 0.1rem var(--p-divider-disabled-on-surface);
      background:transparent;
      color:var(--p-text-disabled-on-surface); }
    .Polaris-Button--outline.Polaris-Button--globalTheming.Polaris-Button--destructive{
      background:transparent;
      box-shadow:0 0 0 0.1rem var(--p-critical-divider);
      ...
      .Polaris-Button--outline.Polaris-Button--globalTheming.Polaris-Button--destructive:focus{
        box-shadow:0 0 0 0.2rem var(--p-critical-divider); }
      ...
      .Polaris-Button--outline.Polaris-Button--globalTheming.Polaris-Button--destructive.Polaris-Button--disabled{
        box-shadow:0 0 0 0.1rem var(--p-critical-divider-disabled);
        background:transparent;
...
.Polaris-ActionList__Section--withoutTitle:not(:first-child){
  border-top:0.1rem solid var(--p-divider-subdued-on-surface, #dfe3e8);
  margin-top:0.8rem;
  padding-top:0.8rem; }
...
.Polaris-OptionList__Title{
  ...
  text-transform:uppercase;
  padding:0.8rem 1.6rem;
  border-bottom:0.1rem solid var(--p-divider-subdued-on-surface, #dfe3e8); }
  @media (min-width: 40em){
    .Polaris-OptionList__Title{
      font-size:1.2rem; } }
...
.Polaris-TextField__Segment{
  ...
  background:linear-gradient(to bottom, white, #f9fafb);
  border:none;
  border-left:0.1rem solid var(--p-divider-on-surface, #c4cdd5);
  ...
  .Polaris-TextField__Segment:not(:first-child){
    margin-top:-1px;
    border-top:0.1rem solid var(--p-divider-on-surface, #c4cdd5); }
...
.Polaris-TextField--globalTheming.Polaris-TextField--error > .Polaris-TextField__Input ~ .Polaris-TextField__Backdrop{
  ...
  border-color:var(--p-critical-divider); }
...
.Polaris-TextField--globalTheming .Polaris-TextField__Backdrop{
  ...
  border:0.1rem solid var(--p-divider-subdued-on-surface);
  border-top-color:var(--p-divider-on-surface);
  border-radius:var(--p-border-radius-base);
  box-shadow:none; }
...
.Polaris-DataTable__Cell--header{
  font-weight:400;
  color:var(--p-text-on-surface, #212b36);
  border-bottom:0.1rem solid var(--p-divider-on-surface, #c4cdd5);
  border-top:0; }
...
.Polaris-DatePicker__Day{
  ...
  padding:0.8rem;
  background:transparent;
  border:0.1rem solid var(--p-divider-subdued-on-surface, #dfe3e8);
  border-radius:0;
  outline:none;
  font-size:1.2rem;
  text-align:center;
...
.Polaris-Sheet{
  ...
  @media screen and (-ms-high-contrast: active){
    .Polaris-Sheet{
      border-left:0.1rem solid var(--p-divider-subdued-on-surface, #dfe3e8); } }
...
.Polaris-Modal-Footer{
  ...
  min-height:6.4rem;
  padding:1.6rem;
  border-top:var(--p-border-subdued, 0.1rem solid var(--p-divider-subdued-on-surface, #dfe3e8)); }
...
.Polaris-Navigation{
  ...
  @media (min-width: 48.0625em){
    .Polaris-Navigation{
      max-width:24rem;
      border-right:var(--p-override-none, 0.1rem solid var(--p-divider-subdued-on-surface, #dfe3e8));
      max-width:24rem;
